...
もしログインでお困りの場合は、システムソリューション課の田中さん（内線4004、katsura@hbm-web.co.jp）にご相談ください。パスワードの再設定などサポートしていただけます。また、私から田中さんに自動でメールをお送りすることも可能ですので、お気軽にお申し付けください。
